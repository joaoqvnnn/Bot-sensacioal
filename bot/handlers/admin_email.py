...
Seção 19 do painel: gerencia configurações de envio de e-mail.
Permite configurar SMTP, remetente, templates de verificação/entrega,
expiração de códigos e tentativas.
"""
...
async def _edit_email_setting(callback: CallbackQuery, state: FSMContext, key: str, title: str):
    """Inicia edição de uma configuração de e-mail."""
...
async def process_email_setting(message: Message, state: FSMContext):
    """Salva o novo valor da configuração de e-mail."""
