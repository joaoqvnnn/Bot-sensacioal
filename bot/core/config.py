...
Este módulo carrega e valida todas as variáveis de ambiente usando
pydantic-settings, garantindo que valores inválidos ou ausentes
sejam detectados logo na inicialização, sem conflitos silenciosos.
"""
...
class Settings(BaseSettings):
    ...
    # ==================================================================
    APP_NAME: str = Field(default="LarizinhaStore")
